...
<body>
  ...
  <div class="row mb-3">
    <label for="inputPassword3" class="col-sm-2 col-form-label">อายุของสุนัข</label>
    <div class="col-sm-2">
  ...
  <div class="row mb-3">
    <label for="inputPassword3" class="col-sm-2 col-form-label">เพศของสุนัข</label>
    <div class="col-sm-2">
    ...
    <div class="row mb-3">
    <label for="inputPassword3" class="col-sm-2 col-form-label">วันที่เกิดของสุนัข</label>
    <div class="col-sm-2">
  ...
  <div class="row mb-3">
    <label for="inputPassword3" class="col-sm-2 col-form-label">สีขนของสุนัข</label>
    <div class="col-sm-2">
  ...
  <div class="row mb-3">
    <label for="inputPassword3" class="col-sm-2 col-form-label">ลักษณะเด่นของสุนัข</label>
    <div class="col-sm-2">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $name=$_POST['ชื่อสุนัข'];
    $pettype=$_POST['สายพันธุ์'] ;
    $breed=$_POST['อายุของสุนัข'];
    $gender=$_POST['เพศของสุนัข'];
    $age=$_POST['วันที่เกิดของสุนัข'] ;
    $weight=$_POST['น้ำหนักปัจจุบัน'];
    $birthday=$_POST['สีขนของสุนัข'];
    $address=$_POST['ลักษณะเด่นของสุนัข'];
